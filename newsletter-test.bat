...
if "%1"=="" (
  echo Usage: newsletter-test ^<data_file^> [options]
  echo.
  ...
  echo.
  echo Examples:
  echo   newsletter-test output\intermediate_processing\collected_articles_processed.json --mode content
  echo   newsletter-test output\intermediate_processing\collected_articles_raw.json --mode content
  echo   newsletter-test output\intermediate_processing\render_data_langgraph_20250522_143255.json --mode template
  echo.
  echo Note:
