...
def list_tests(include_backup=False):
    """
...
def main():
    ...
    if args.list or args.list_all:
        list_tests(include_backup=args.list_all)
        return 0
    ...
    if args.full:
        ...
        return 0 if result and result.returncode == 0 else 1
    elif args.all or not (args.list or args.list_all or args.test or args.format_only):
        # 기본 동작: 메인 테스트만 실행
