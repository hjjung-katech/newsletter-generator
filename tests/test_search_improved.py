...
class TestSearchImproved(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.assertTrue(self.api_key, "SERPER_API_KEY가 설정되지 않았습니다. .env 파일을 확인하세요.")
    ...
    def test_combine_results_from_multiple_keywords(self):
        ...
        keyword3_response = {
            "news": [
                {"title": "키워드1 뉴스", "link": "https://example.com/k1news1"},  # 중복
        ...
        # 검증 - 중복 제거로 5개가 아닌 4개여야 함
        self.assertEqual(len(combined), 5 - 1)
