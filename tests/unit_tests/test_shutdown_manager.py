...
class TestShutdownManager:
    ...
    def test_shutdown_phases(self):
        ...
        manager.register_shutdown_task("task1", task1, ShutdownPhase.STOPPING_NEW_REQUESTS, priority=10)
        manager.register_shutdown_task("task2", task2, ShutdownPhase.WAITING_FOR_TASKS, priority=20)
        manager.register_shutdown_task("task3", task3, ShutdownPhase.CLEANING_RESOURCES, priority=30)
    ...
    def test_shutdown_task_priorities(self):
        ...
        manager.register_shutdown_task("low", low_priority, ShutdownPhase.CLEANING_RESOURCES, priority=50)
        manager.register_shutdown_task("high", high_priority, ShutdownPhase.CLEANING_RESOURCES, priority=10)
