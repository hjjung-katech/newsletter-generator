...
def main():
    ...
    parser.add_argument("--real-api", action="store_true", 
                       help="Enable real API tests")
    parser.add_argument("--web-server-check", action="store_true",
    ...
    if args.level == "all":
        ...
        print(f"   • Run 'python -m pytest tests/e2e/test_schedule_e2e.py -m manual' for live tests")
