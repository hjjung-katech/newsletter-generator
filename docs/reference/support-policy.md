...
|---|---|---|---|---|---|---|
| Linux | 1차 지원 | 정식 지원 | Ubuntu 기반 unit/mock/integration + package build | canonical | 비정본 | 현재 repo-shipped production 경로는 Railway/Nixpacks 기반 Flask/Gunicorn source deploy |
