...
> **💡 로컬 개발 vs 프로덕션 배포**
>
> - **로컬 개발**: Redis 불필요, `python -m web.app`만으로 실행 가능
...
|-----------|-----------|------------------|
| **웹 서버** | `python -m web.app` | Gunicorn + 다중 워커 |
...
python -m web.worker           # 터미널 1
python -m web.schedule_runner  # 터미널 2
python -m web.app              # 터미널 3
```
...
Start-Process -NoNewWindow python -m web.worker
Start-Process -NoNewWindow python -m web.schedule_runner
python -m web.app
```
