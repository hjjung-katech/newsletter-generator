...
> **💡 로컬 개발 vs 프로덕션 배포**
>
> - **로컬 개발**: Redis 불필요, `python apps/web/main.py`만으로 실행 가능
...
|-----------|-----------|------------------|
| **웹 서버** | `python apps/web/main.py` | Gunicorn + 다중 워커 |
...
python apps/worker/main.py     # 터미널 1
python apps/scheduler/main.py  # 터미널 2
python apps/web/main.py        # 터미널 3
```
...
Start-Process -NoNewWindow python apps/worker/main.py
Start-Process -NoNewWindow python apps/scheduler/main.py
python apps/web/main.py
```
