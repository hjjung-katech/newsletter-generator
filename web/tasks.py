    ...
    def collect_articles(self, keywords=None, domain=None):
        ...
        if keywords:
            if isinstance(keywords, list):
                keywords_iter = [k.strip() for k in keywords]
            else:
                keywords_iter = [k.strip() for k in keywords.split(",")]
            articles = []
...
def generate_newsletter_task(params, job_id):
    ...
    try:
        ...
        if "keywords" in params:
            articles = newsletter_generator.collect_articles(
        ...
        html_content = newsletter_generator.compose_newsletter(
            summarized_articles, title
        )
        ...
        if params.get("email") and not params.get("preview_only"):
            email_sent = newsletter_generator.send_newsletter_email(
                html_content, params["email"], title
            )
