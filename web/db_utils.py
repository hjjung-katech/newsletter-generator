...
def execute_query(cursor: sqlite3.Cursor, query: str, params: Optional[Tuple] = None, 
                  log_level: str = "DEBUG") -> sqlite3.Cursor:
    """
...
def execute_many(cursor: sqlite3.Cursor, query: str, params_list: list,
                 log_level: str = "DEBUG") -> sqlite3.Cursor:
    """
