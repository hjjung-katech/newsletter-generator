    ...
    def has_api_keys_configured(self):
        ...
        try:
            with open(env_file, 'r', encoding='utf-8') as f:
                ...
                has_gemini = 'GEMINI_API_KEY=' in content and not 'YOUR_GEMINI_API_KEY' in content
                has_serper = 'SERPER_API_KEY=' in content and not 'YOUR_SERPER_API_KEY' in content
