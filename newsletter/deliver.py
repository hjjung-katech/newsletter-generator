...
def save_to_drive(html_content: str, filename_base: str):
    ...
    if not config.GOOGLE_APPLICATION_CREDENTIALS:
        print("Warning: GOOGLE_APPLICATION_CREDENTIALS not set. Skipping Google Drive upload.")
        return False
    ...
    try:
        ...
        service.files().create(body=file_metadata_html, media_body=media_html, fields='id').execute()
        ...
        service.files().create(body=file_metadata_md, media_body=media_md, fields='id').execute()
